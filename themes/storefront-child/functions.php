 ...
 * Define Constants
 */
define( 'CHILD_THEME_STOREFRONT_CHILD_VERSION', '1.0.0' );
defined( 'THEME_URI' ) or define( 'THEME_URI', get_stylesheet_directory_uri() );
defined( 'THEME_DIR' ) or define( 'THEME_DIR', get_stylesheet_directory() );
...
function child_enqueue_styles() {
        ...
        include_once( THEME_DIR . '/enq-scripts/masonry.pkgd.php' );
